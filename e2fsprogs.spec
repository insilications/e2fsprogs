...
Version  : 1.43.6
Release  : 48
URL      : https://sourceforge.net/projects/e2fsprogs/files/e2fsprogs/v1.43.6/e2fsprogs-1.43.6.tar.gz
Source0  : https://sourceforge.net/projects/e2fsprogs/files/e2fsprogs/v1.43.6/e2fsprogs-1.43.6.tar.gz
Source99 : https://sourceforge.net/projects/e2fsprogs/files/e2fsprogs/v1.43.6/e2fsprogs-1.43.6.tar.gz.asc
...
%prep
%setup -q -n e2fsprogs-1.43.6
%patch1 -p1
%patch2 -p1
pushd ..
cp -a e2fsprogs-1.43.6 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1504114012
